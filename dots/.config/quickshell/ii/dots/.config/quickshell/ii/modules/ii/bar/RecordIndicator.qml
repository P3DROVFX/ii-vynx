...
MouseArea {
    ...
    Loader {
        ...
        sourceComponent: RowLayout {
            ...
            MaterialSymbol {
                ...
                id: iconIndicator
                z: 1
                text: indicator.isLoading ? "sync" : "screen_record"
    ...
    component PopupContent: ColumnLayout {
        ...
        RowLayout {
            ...
            StyledText {
                text: indicator.isLoading ? "Loading OBS..." : Translation.tr("Recording...   %1").arg(indicator.formatTime(Persistent.states.screenRecord.seconds))
            }
        }
        RowLayout {
            MaterialSymbol {
