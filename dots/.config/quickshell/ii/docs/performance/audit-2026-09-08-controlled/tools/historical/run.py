...
CASES=[
 {'id':'repeat_keybinds_keep','path':'modules/ii/cheatsheet/Cheatsheet.qml','kind':'cheatsheet','keep':True,'tab':'keybinds','samePrewarm':True},
 {'id':'repeat_keybinds_unload','path':'modules/ii/cheatsheet/Cheatsheet.qml','kind':'cheatsheet','keep':False,'tab':'keybinds','samePrewarm':True},
 {'id':'phone_only','path':'modules/ii/sidebarPolicies/SidebarPolicies.qml','kind':'policies','keep':False,'tab':0,'policyOnly':True},
 {'id':'repeat_timetable','path':'modules/ii/cheatsheet/Cheatsheet.qml','kind':'cheatsheet','keep':False,'tab':'timetable'},
 {'id':'bar_no_privacy','path':'modules/ii/verticalBar/VerticalBar.qml','kind':'bar','noPrivacy':True},
 {'id':'family_fork','path':'panelFamilies/IllogicalImpulseFamily.qml','kind':'resident','productionConfig':True},
