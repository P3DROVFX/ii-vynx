...
CASES=[{'id': 'dashboard_keep', 'path': 'modules/ii/sidebarDashboard/SidebarDashboard.qml', 'kind': 'dashboard', 'keep': True}, {'id': 'dashboard_unload', 'path': 'modules/ii/sidebarDashboard/SidebarDashboard.qml', 'kind': 'dashboard', 'keep': False}, {'id': 'policies_ai_keep', 'path': 'modules/ii/sidebarPolicies/SidebarPolicies.qml', 'kind': 'policies', 'keep': True, 'tab': 0}, {'id': 'policies_ai_unload', 'path': 'modules/ii/sidebarPolicies/SidebarPolicies.qml', 'kind': 'policies', 'keep': False, 'tab': 0}, {'id': 'cheatsheet_keybinds_keep', 'path': 'modules/ii/cheatsheet/Cheatsheet.qml', 'kind': 'cheatsheet', 'keep': True, 'tab': 'keybinds', 'samePrewarm': True}, {'id': 'cheatsheet_keybinds_unload', 'path': 'modules/ii/cheatsheet/Cheatsheet.qml', 'kind': 'cheatsheet', 'keep': False, 'tab': 'keybinds'}, {'id': 'cheatsheet_timetable', 'path': 'modules/ii/cheatsheet/Cheatsheet.qml', 'kind': 'cheatsheet', 'keep': False, 'tab': 'timetable'}, {'id': 'cheatsheet_commands', 'path': 'modules/ii/cheatsheet/Cheatsheet.qml', 'kind': 'cheatsheet', 'keep': False, 'tab': 'commands'}, {'id': 'overview', 'path': 'modules/ii/overview/Overview.qml', 'kind': 'overview'}, {'id': 'settings_colors', 'path': 'SettingsWindow.qml', 'kind': 'settings', 'tab': 'colors'}, {'id': 'settings_bar', 'path': 'SettingsWindow.qml', 'kind': 'settings', 'tab': 'bar'}, {'id': 'usage', 'path': 'modules/ii/usage/Usage.qml', 'kind': 'usage'}, {'id': 'notes', 'path': 'modules/ii/notes/NotesApp.qml', 'kind': 'notes'}, {'id': 'wallpaper_selector', 'path': 'modules/ii/wallpaperSelector/WallpaperSelector.qml', 'kind': 'wallpaper'}, {'id': 'background', 'path': 'modules/ii/background/Background.qml', 'kind': 'resident'}, {'id': 'vertical_bar', 'path': 'modules/ii/verticalBar/VerticalBar.qml', 'kind': 'bar'}, {'id': 'dock', 'path': 'modules/ii/dock/Dock.qml', 'kind': 'resident'}, {'id': 'media_mode', 'path': 'modules/ii/background/Background.qml', 'kind': 'media'}, {'id': 'repeat_keybinds_keep', 'path': 'modules/ii/cheatsheet/Cheatsheet.qml', 'kind': 'cheatsheet', 'keep': True, 'tab': 'keybinds', 'samePrewarm': True}, {'id': 'repeat_keybinds_unload', 'path': 'modules/ii/cheatsheet/Cheatsheet.qml', 'kind': 'cheatsheet', 'keep': False, 'tab': 'keybinds', 'samePrewarm': True}, {'id': 'phone_only', 'path': 'modules/ii/sidebarPolicies/SidebarPolicies.qml', 'kind': 'policies', 'keep': False, 'tab': 0, 'policyOnly': True}, {'id': 'repeat_timetable', 'path': 'modules/ii/cheatsheet/Cheatsheet.qml', 'kind': 'cheatsheet', 'keep': False, 'tab': 'timetable'}, {'id': 'bar_no_privacy', 'path': 'modules/ii/verticalBar/VerticalBar.qml', 'kind': 'bar', 'noPrivacy': True}, {'id': 'family_fork', 'path': 'panelFamilies/IllogicalImpulseFamily.qml', 'kind': 'resident', 'productionConfig': True}, {'id': 'family_upstream', 'path': 'panelFamilies/IllogicalImpulseFamily.qml', 'kind': 'resident', 'upstream': True, 'productionConfig': True}, {'id': 'bar_reference', 'path': 'modules/ii/verticalBar/VerticalBar.qml', 'kind': 'bar'}, {'id': 'bar_active_layout', 'path': 'modules/ii/verticalBar/VerticalBarAudit.qml', 'kind': 'bar'}, {'id': 'media_reference', 'path': 'modules/ii/background/Background.qml', 'kind': 'media'}, {'id': 'media_static', 'path': 'modules/ii/background/Background.qml', 'kind': 'media', 'staticMedia': True}, {'id': 'family_fork_no_prewarm', 'path': 'panelFamilies/IllogicalImpulseFamily.qml', 'kind': 'resident', 'productionConfig': False}, {'id': 'cheatsheet_timetable_grid_only', 'path': 'modules/ii/cheatsheet/CheatsheetAudit.qml', 'kind': 'cheatsheet', 'keep': False, 'tab': 'timetable'}, {'id': 'notes_list_only', 'path': 'modules/ii/notes/NotesAppAudit.qml', 'kind': 'notes'}, {'id': 'family_nav_keep', 'path': 'panelFamilies/IllogicalImpulseFamily.qml', 'kind': 'resident', 'productionConfig': False, 'keep': True, 'navSeq': True}, {'id': 'family_nav_unload', 'path': 'panelFamilies/IllogicalImpulseFamily.qml', 'kind': 'resident', 'productionConfig': False, 'keep': False, 'navSeq': True}]
...
ShellRoot {
 ...
 property int requestedPolicy: test.tab || 0
 Timer {id:selectPolicy;interval:1200;onTriggered:{Persistent.states.sidebar.policies.tab=root.requestedPolicy;root.mark("policy-selected");}}
 ...
 function mark(extra) {
  console.warn("IIAUDIT " + JSON.stringify({time:Date.now(),phase:phase,status:target.status,
   ...
   policyTab:(!test.upstream && test.kind === "policies") ? Persistent.states.sidebar.policies.tab : null,
   policyIcon:(!test.upstream && test.kind === "policies" && target.item && target.item.sidebarContent) ? target.item.sidebarContent.activeTabs[Persistent.states.sidebar.policies.tab]?.icon : null,
   cheatTab:(!test.upstream && test.kind === "cheatsheet" && target.item) ? target.item.tabButtonList[Persistent.states.cheatsheet.tabIndex]?.id : null,
 ...
 function load() {
  target.source=Qt.resolvedUrl(test.path);
  if(test.kind === "cheatsheet" && test.samePrewarm) {
   GlobalStates.cheatsheetPendingTab=test.tab;target.item.consumePendingTab();
  }
 }
 function open() {
  if (!target.item) load();
  if (test.kind === "dashboard") GlobalStates.openRightSidebar("eDP-1");
  else if (test.kind === "policies") {GlobalStates.openLeftSidebar("eDP-1");selectPolicy.restart();}
 ...
 function next() {
  ...
  else if (phase === "open_policies_ai") { GlobalStates.openLeftSidebar("eDP-1"); Persistent.states.sidebar.policies.tab = 0; }
  else if (phase === "nav_policies_phone") { Persistent.states.sidebar.policies.tab = 1; }
  else if (phase === "policies_closed") { GlobalStates.sidebarLeftOpen = false; }
  else if (phase === "open_cheatsheet_keybinds") { GlobalStates.openCheatsheet("keybinds"); }
  else if (phase === "nav_cheatsheet_timetable") { GlobalStates.openCheatsheet("timetable"); }
  else if (phase === "cheatsheet_closed") { GlobalStates.closeCheatsheet(); }
  else if (phase === "open_dashboard") { GlobalStates.openRightSidebar("eDP-1"); }
  else if (phase === "dashboard_closed") { GlobalStates.sidebarRightOpen = false; }
 ...
 Timer {
  ...
  onTriggered:{
   ...
   if (!root.test.productionConfig && !root.test.upstream) {
   Config.options.sidebar.keepLeftSidebarLoaded=!!root.test.keep && (root.test.kind === "policies" || !!root.test.navSeq);
   Config.options.sidebar.keepRightSidebarLoaded=!!root.test.keep && (root.test.kind === "dashboard" || !!root.test.navSeq);
   ...
   if(root.test.policyOnly) {
    Config.options.policies.ai=0;Config.options.policies.translator=0;
    Config.options.policies.player=0;Config.options.policies.wallpapers=0;
    Config.options.policies.weeb=0;Config.options.policies.phone=1;
   }
   if(root.test.noPrivacy) Config.options.bar.privacyPill.enabled=false;
...
def box():
 ...
 for a,b in [(BASE,BASE),(HOME_PATH/'.config',BASE/'host-config'),(BASE/'config-root',HOME_PATH/'.config'),(BASE/('upstream' if UPSTREAM else 'source'),SRC),(BASE/'run-config',HOME_PATH/'.config/illogical-impulse'),(BASE/'run-state',HOME_PATH/'.local/state/quickshell'),(BASE/'run-cache',HOME_PATH/'.cache/quickshell'),(RUNTIME,RUNTIME)]:
...
def run_case(case,stages):
 global UPSTREAM
 UPSTREAM=case.get('upstream',False)
 if (RESULTS/case['id']).exists():raise RuntimeError('Case output already exists; use a fresh prepared directory')
 cpseed()
 (BASE/('upstream' if UPSTREAM else 'source')/'shell.qml').write_text(DRIVER.replace('__CASE__',json.dumps(case)).replace('__STAGES__',json.dumps(stages)).replace('__IMPORT__', 'import qs.' + str(Path(case['path']).parent).replace('/', '.') if '/' in case['path'] else ''))
  ...
  while time.monotonic()-begin < sum(x['seconds'] for x in stages)+90:
   ...
   if pid:
    ...
    if foundat is not None and elapsed-foundat>=10 and phase not in checkphases:
     result.setdefault('playbackByPhase',{})[phase]=subprocess.run(['playerctl','--all-players','--format','{{playerName}} {{status}}','status'],capture_output=True,text=True).stdout.splitlines();result['maps'][phase]=proc.memory_maps(pid)['groupsMiB']; result['surfaces'][phase]=snapshots();checkphases.add(phase)
   time.sleep(1)
 ...
 print(json.dumps({'case':case['id'],'complete':True,'result':str(path/'measurements.json')}),flush=True)
 return result
ACTIVE=None
UPSTREAM=False
STOPPED=False
...
def main():
 global STOPPED,WORKSPACE,ORIGINAL_HASH,PROD_PID
 signal.signal(signal.SIGTERM,signal_handler);signal.signal(signal.SIGINT,signal_handler)
 selection=sys.argv[1:]
 if not selection:raise SystemExit('Specify explicit case IDs from cases.json; no shell was stopped.')
 ...
 if any((RESULTS/c['id']).exists() for c in cases):raise SystemExit('Existing results: prepare a fresh directory; nothing was stopped.')
 ...
 try:
  ...
  stages=[{'phase':'core','seconds':30},{'phase':'controller','seconds':20},{'phase':'open','seconds':30},{'phase':'closed','seconds':30},{'phase':'reopen','seconds':20},{'phase':'closed_again','seconds':25},{'phase':'unloaded','seconds':20},{'phase':'gc','seconds':20}]
  stagefile=BASE/'stages.json'
  if stagefile.exists():stages=json.loads(stagefile.read_text())
  for case in cases:
